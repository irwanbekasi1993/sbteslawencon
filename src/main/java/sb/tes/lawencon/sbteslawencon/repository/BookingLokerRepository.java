...
public interface BookingLokerRepository extends JpaRepository<BookingLoker,Long>{
   ...
   BookingLoker getLokerByNomorLoker(@Param("nomorLoker")int nomorLoker);
    ...
    @Modifying
    @Query(value="update booking_loker set status_booking='not booked', end_date=current_timestamp where nomor_loker=:nomorLoker ",nativeQuery = true)
    int updateReturningStatus(@Param("nomorLoker")int nomorLoker);
    ...
    @Query(value="select * from booking_loker where status_booking='saving' and nomor_loker=:nomorLoker",nativeQuery = true)
    BookingLoker getBookingSaving(@Param("nomorLoker")int nomorLoker);

    @Query(value="select * from booking_loker where status_booking='returning' and nomor_loker=:nomorLoker",nativeQuery = true)
    BookingLoker getBookingReturning(@Param("nomorLoker")int nomorLoker);
